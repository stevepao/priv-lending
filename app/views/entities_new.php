...
<?php else: ?>
<form class="space-y-4 rounded border border-slate-200 bg-white p-4 shadow-sm" method="post" action="/entities/new">
<?php echo csrf_field(); ?>
...
<?php $bid = (string) ($b['id'] ?? ''); $bname = (string) ($b['name'] ?? ''); ?>
<option value="<?php echo e($bid); ?>"><?php echo e($bname); ?></option>
<?php endforeach; ?>
</select></div>
