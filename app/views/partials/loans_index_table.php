...
<td class="px-3 py-2 font-mono italic text-slate-800" title="Sum of cash_events.amount for principal_in and principal_out on this loan (funding negative, repayments positive; zero when fully repaid)."><?php echo e(checks_format_money_display_2($lr['currentBalance'])); ?></td>
<td class="px-3 py-2"<?php echo $lr['principalTitle'] !== '' ? ' title="' . e($lr['principalTitle']) . '"' : ''; ?>><?php echo e(checks_format_money_display_2($lr['principal'])); ?></td>
